        ...
        <div className="mt-8 p-5 bg-blue-50 border border-blue-100 rounded-2xl flex gap-4 items-start mb-12">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 leading-relaxed">
              Gunakan skala nilai di atas sebagai acuan standar saat memberikan keterangan atau penilaian pada <strong>Presensi &amp; Harian</strong>, <strong>Ujian Kenaikan Level</strong>, dan <strong>Form Munaqosyah</strong>. Pastikan nilai yang diberikan sesuai dengan kualitas bacaan dan hafalan siswa.
            </p>
          </div>
        </div>
